...
def carregar_bases(upload=False):
    if upload or 'novo_df' not in st.session_state or 'tomb_df' not in st.session_state:
...
if "arquivo_novo" not in st.session_state or "arquivo_tomb" not in st.session_state:
    st.info("Carregue os arquivos iniciais para iniciar.")
